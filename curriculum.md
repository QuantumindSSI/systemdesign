...
- **Evals**: computational checks (linters, tests — deterministic) vs. LLM-as-judge (inferential) — know when each applies, and that harnessability should be a first-class architecture criterion, not an afterthought
