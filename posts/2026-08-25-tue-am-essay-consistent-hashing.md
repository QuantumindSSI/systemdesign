# Week 1 · Tue 2026-08-25 · Long-form: Tracing the 79 Lines That Implement Consistent Hashing

> Calendar row: W1 Tue AM, 09:00. Format: long-form Substack essay (this
> essay's structural spine follows the calendar's "repo walkthrough" format
...
>
> Editorial note inherited from `prep/week-01/tue-2026-08-25-repo-walkthrough.md`:
> the calendar's originally committed brief paired this repo with PACELC,
> and the string "PACELC" appears nowhere in the repository (grep over the
> full clone, 2026-08-22). Resolved as Option A: this essay walks the
> repo's real consistent-hashing code; PACELC stays in this afternoon's
> 17:00 follow-up as a standalone runnable snippet
> (`posts/2026-08-25-tue-pm-followup-pacelc-snippet.md`), which does not
> depend on this repo.
>
...
*This afternoon, 17:00: a different corner of the same week's material, a
runnable PACELC snippet
(`posts/2026-08-25-tue-pm-followup-pacelc-snippet.md`) measuring the other
tradeoff this week is built around: not what happens when a node leaves the
ring, but what a healthy, fully connected ring still has to pay for on every
single request. Tomorrow, 09:00: this exact ring, at Amazon's scale, in
