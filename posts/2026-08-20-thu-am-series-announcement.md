...
> - "ninety-five percent" — MIT Project NANDA, "The GenAI Divide: State of AI in
>   Business 2025"; measures NO MEASURABLE P&L IMPACT (not prototype death);
>   methodology (52 interviews / 153 surveyed / 300 deployments) cited via press
>   coverage; NANDA's existence verified directly at nanda.media.mit.edu 2026-08-21 ✓
> - "eighty-eight percent" — Iris.ai 2026 enterprise analysis, as reported;
>   production-arrival stat — the one that actually matches "dying in prototype" ✓
> - base-rate caveat included: high pilot attrition is normal enterprise-tech
>   behaviour; AI-specific-crisis framing is contestable ✓
...
> - The "twenty-nine repositories" commitment was removed 2026-09-06 under the
>   canonical source rule (`AGENTS.md`). The series no longer sources code from
>   external repositories, so a promise to verify them was obsolete and is
>   replaced by the promise actually being kept: our own tested implementations,
>   plus papers, RFCs and vendor documentation ✓
...
There is a number that gets passed around for this, and unlike most numbers in this industry, it has a real source that the retelling has flattened. The source is MIT's Project NANDA, in a report titled "The GenAI Divide: State of AI in Business 2025", built — per its reported methodology — on fifty-two executive interviews, surveys of one hundred and fifty-three leaders, and analysis of three hundred public deployments. What it found is narrower than the headline: ninety-five percent of enterprise generative AI pilots produced no measurable profit-and-loss impact. Not crashed. Not cancelled. In many cases still running, and moving no business number at all. The statistic that matches my opening image — projects dying before they ever reach production — is a different one: Iris.ai's 2026 enterprise analysis, as reported, puts that figure at eighty-eight percent. Two different failure modes wear the same headline in the retellings, and precision demands that they be separated. Fairness demands one more thing: there is a reasonable pushback that pilots are supposed to fail, that high pilot attrition is normal for any enterprise technology, and that dressing it up as an AI-specific crisis is framing, not finding. And because this series promised verified citations, here is the chain of custody in full: I verified directly that Project NANDA exists at MIT's Media Lab; the report's methodology and findings I cite through press coverage, because most of what circulates online is secondary commentary that names MIT without linking the study. That is the honest state of this number. What I can defend without any survey at all is what I have seen in the projects I have personally been close to, and it is consistent: the model is almost never the cause of death. My sample is small and specific — enterprise deployments I could inspect myself — and the claim carries that boundary. I assert it for systems of that shape. I make no claim about research prototypes or consumer products I have never audited. The cause of death is everything around the model. Nobody designed the tools, so the agent burns its context guessing at them. Nobody versioned the prompts, so nobody can say which change broke the behaviour. Nobody decided when a human gets to veto an irreversible action, so either everything requires approval and the reviewer stops reading, or nothing does and the first bad day becomes an incident. Nobody wrote an evaluation, so nobody can tell a regression from bad luck. The project runs on hope and a demonstration dataset until the hope runs out.
...
A series about engineering discipline must survive its own standards, so this one runs under five commitments. First: everything is pre-registered. All one thousand four hundred and six planned posts sit in version control, committed before this first one went out. If I rewrite the plan to look wiser in hindsight, the history will contradict me. Second: nothing is cited unverified, and every implementation is our own. Sources are papers, standards documents and first-party vendor documentation, each re-checked on the day it is quoted. Code is not borrowed from somebody else's repository and summarised; it is written into this series' own repository, tested, and then read line by line in public. When a source turns out to be dead or wrong, it gets a burial and a note, not a silent replacement. Third: every number names its source in the sentence that uses it, or admits that it cannot. You watched that rule dissect this article's own headline statistic into two different studies measuring two different deaths. Fourth: corrections are content. When something I teach turns out wrong, the correction is published as its own post. Fifth: the plan updates on evidence — which brings me to this evening.
