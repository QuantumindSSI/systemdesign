...
> - The quorum figures below (7.7ms / 16.0ms p50, 67.0% / 0.0% stale) are
>   produced by this evening's code deep-dive
...
>   session; (3,2,2) itself is quoted from the paper, not asserted.
